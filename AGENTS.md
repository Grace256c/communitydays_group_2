# Agriculture — Group 2: agent and developer guide
...
- **Theme:** Agriculture.
- **Register:** garden (`group_2_registration`).
- **Follow-up action:** Record a garden visit (`group_2_followup`).
...
| Registration questions | `forms/group_2_registration/schema.json` and `ui.json` |
| Follow-up questions | `forms/group_2_followup/schema.json` and `ui.json` |
